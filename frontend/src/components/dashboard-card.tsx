...
export const DashboardCard = ({ nutrient, quantity, unit, success }: DashboardCardProps) => {
    return (
        <Card className={`@container/card ${success ? "border-green-500" : "border-red-500"}`}>
            <CardHeader>
                ...
                <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">{quantity} <span className="text-sm font-medium">{unit}</span></CardTitle>
            </CardHeader>
